export const loginData = {
 ...
 export const tableData = [
  ...
  export const itemstableData = [
    { itemId: '1', item: 'item A', ppu: 28.76, available: 10,date:'12/2/2024' },
    { itemId: '2', item: 'item B', ppu: 21.06, available: 20,date:'12/1/2021' },
    { itemId: '3', item: 'item C', ppu: 35.00, available: 80 ,date:'1/22/2020'},
    { itemId: '4', item: 'item D', ppu: 82.00, available: 78,date:'4/7/2024' },
    { itemId: '5', item: 'item E', ppu: 98.05, available: 12,date:'6/3/2024' }
  ];
  ...
  export const ExpableData = [
    { expId: '1', expDetail: 'Expense A',amount:200,status:"Pending",date:'12/2/2024' },
    { expId: '2', expDetail: 'Expense B', amount:400,status:"In progress",date:'12/1/2021' },
    { expId: '3', expDetail: 'Expense C',amount:100,status:"Fixed",date:'1/22/2020'},
    { expId: '4', expDetail: 'Expense D',amount:50,status:"Completed",date:'4/7/2024' },
    { expId: '5', expDetail: 'Expense E',amount:800,status:"Completed",date:'6/3/2024' }
  ];